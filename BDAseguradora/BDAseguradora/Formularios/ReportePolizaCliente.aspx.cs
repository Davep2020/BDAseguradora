...
{
    public partial class ReportePolizaCliente : System.Web.UI.Page
    {
        ...
        void construirReporte()
        {
            ...
            else
            {
                ...
                List<spDatosReportePolizasCliente_Result> datosReporte = this.retornaDatosReporte(Session["correo"].ToString());
        ...
        /// <returns></returns>
        List<spDatosReportePolizasCliente_Result> retornaDatosReporte(string pCorreo)
        {
            return this.modeloBD.spDatosReportePolizasCliente(pCorreo).ToList();
