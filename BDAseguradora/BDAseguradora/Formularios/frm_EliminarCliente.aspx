<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="frm_EliminarCliente.aspx.cs" Inherits="BDAseguradora.Formularios.frm_EliminarCliente" %>
        ...
        <div class="container">
            ...
            <asp:CompareValidator ID="cmptxtCedula" runat="server" ErrorMessage="Debe digitar números en la cédula, sin espacios ni guiones"
              ...
              <div class="form-group">
                  ...
                  <asp:TextBox ID="txtGenero" runat="server" CssClass="form-control" Enabled="False"></asp:TextBox>
              ...
              <div class="form-group">
                  ...
                  <asp:TextBox ID="txtFecha_Nacimiento" runat="server" CssClass="form-control" Enabled="False"></asp:TextBox>
