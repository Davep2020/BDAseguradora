...
namespace BDAseguradora.Modelo
{
    ...
    public partial class bdaseguradoraEntities : DbContext
    {
        ...
        public virtual ObjectResult<spMostrarClientes_Result> spMostrarClientes()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spMostrarClientes_Result>("spMostrarClientes");
        }
    }
}
